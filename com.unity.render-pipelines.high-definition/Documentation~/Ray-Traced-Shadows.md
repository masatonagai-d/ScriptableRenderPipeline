...
Ray-traced shadows offer the possibility of colored shadows for Directional Lights cast by tranparent and transmissive GameObjects.
...
| **Color Shadow**      | Enables transparent and transmissive objects to cast color shadows. |
...
| **Color Shadow**      | Enables transparent and transmissive objects to cast semi-transparent shadows. |
